 ...
 * ------------------------
 *
 * $RCSfile: loca_const.h,v $
 *
 * $Author: edwilke $
 *
 * $Date: 2002/07/12 19:38:47 $
 *
 * $Revision: 1.12 $
 *
 * $Name:  $
...
static char *cvs_conconsth_id =
  "$Id: loca_const.h,v 1.12 2002/07/12 19:38:47 edwilke Exp $";
#endif
*/
 ...
 * present in loca_parameters.f90
...
#ifdef LOCA_MF
#include <mf.h>
#else     /* Make up something so code compiles without MF includes */
...
extern void calc_rhs_multi(double *param_vec, int i, int k,  double *phix,
                    double *rhs, double *x, double perturb, int numUnks);
